...
album.src=`../src/assets/images/${song}.png`
...
function playSong(){
    ...
    document.querySelector(".play").style.backgroundImage="url('../src/assets/icons/media-pause.svg')"
...
function pauseSong(){
    ...
    document.querySelector(".play").style.backgroundImage="url('../src/assets/icons/media-play.svg')"
